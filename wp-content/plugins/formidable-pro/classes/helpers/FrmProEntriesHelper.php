...
class FrmProEntriesHelper {
	...
	public static function allow_form_edit( $action, $form ) {
		...
		if ( ( $form->editable && ( ! empty( $form->options['single_entry'] ) && isset( $form->options['single_entry_type'] ) && $form->options['single_entry_type'] === 'user' ) || ! empty( $form->options['save_draft'] ) ) ) {
